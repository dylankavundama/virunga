class Post {
  ...
  Post(this.id, this.image, this.titre, this.descri);
}
...
List<Post> posts = [
  ...
  Post(
      ...
      "'international Ghanéen 🇬🇭 arrive, Déjà à l’aéroport en direction de Kigali ( Rwanda 🇷🇼 ) pour Goma, GODWIN est le premier recrut à l’international avant l’arrivé de deux européens la semaine qui se pointe à l’horizon"),
  Post(
      5,
      'asset/post/f.jpg',
